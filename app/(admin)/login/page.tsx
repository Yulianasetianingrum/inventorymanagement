            ...
            <form method="post" action="/api/auth/login-admin" className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none opacity-30 group-focus-within:opacity-100 transition-opacity text-white">
                    👤
                  </div>
                  <input
                    name="employeeId"
                    ...
                    className="w-full h-14 pl-12 pr-4 bg-navy-light border border-navy-deep rounded-2xl font-bold text-white placeholder:text-white/20 focus:ring-2 focus:ring-gold focus:outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full h-14 pl-12 pr-12 bg-navy-light border border-navy-deep rounded-2xl font-bold text-white placeholder:text-white/20 focus:ring-2 focus:ring-gold focus:outline-none transition-all"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                className="btn-gold w-full !h-14 shadow-2xl shadow-gold/20 active:scale-[0.98] transition-all"
              >
                SIGN IN SECURELY
              </button>
            </form>
